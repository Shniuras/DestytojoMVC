...
Copied from GitHub, requires revision
...
function reset() {
    first_dice_img.src = "../app/views/assets/img/dices/6.png";
    second_dice_img.src = "../app/views/assets/img/dices/6.png";
    third_dice_img.src = "../app/views/assets/img/dices/6.png";
...
function show_dices(game) {
    ...
    first_dice_img.src = "../app/views/assets/img/dices/"+game[0]+".png";
    second_dice_img.src = "../app/views/assets/img/dices/"+game[1]+".png";
    third_dice_img.src = "../app/views/assets/img/dices/"+game[2]+".png";

    // parodom visus kauliukus
    result_div.innerHTML += "Roll "+(roll_count+1)+": " + game[0] + " / " +game[1]+" / "+game[2]+"<br>";
}

// postinam  laimejima i duomenu baze
function post_result() {
    $.post("../Dice/submitResult",
        {
            result: win/10
        },
        function (response) {
...
function check_for_win() {
    if (win == 0) {
        win_div.innerHTML = "Game over!<br>You didn't win anything.";
    } else {
        win_div.innerHTML = 'Game over!<br>You won: '+win/10+' euro';
    }
}
